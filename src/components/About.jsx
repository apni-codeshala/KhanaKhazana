    ...
    render() {
        return (
            <>
                ...
                <section id="features"
                    className="h-svh justify-center flex flex-col relative block px-6 py-10 md:py-20 md:px-10  border-t border-b border-neutral-900 bg-neutral-900/30">
                ...
                <Profile name={"Abhishek Class"} xyz="abc" />
            </>
        );
    }
